...
<div class="votes">
  ...
  ?>
      ...
      <br>
      <br>
      <a class="right" href="<?=$this->url->create('question/comment/' . $id) ?>">kommentera</a>
    </div>
    <!-- -------------------------------------------------- COMMENTS ---------------------------------------------------- -->
<div class="comments">
  ...
  <?php foreach($answers as $answer): ?>
    ...
    <div class="answer">
      ...
      <div class="votes1">
        ...
        <a class="right" href="<?=$this->url->create('question/commentOnAnswer/' . $thisId . '/' . $question->id) ?>">kommentera</a><br>
        <a class="right" href="<?=$this->url->create('question/accept/' . $thisId . '/' . $question->id . '/' . $question->name) ?>">acceptera</a>
